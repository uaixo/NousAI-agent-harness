...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-37e6d1788ab749d783da8bf95734ceb4bf156262a48800221469cb596d3019bf) |

消息源兼容策略：`source` — `session-source-attribution` v1; `session.developer-message.source`; `kind`; `preserve`.

仅表示归属的新增 kind：`Runtime context`, `tmux-context`.
...
| `Runtime context` | `"catalog"` | 无 | [`{ kind: "Runtime context", form: "catalog" }`](#persistence-type-sha256-07579d27235305b9056a38649ef4d08ba996b06ad3d7cfcd4bbb6b5df8c78a1b) |
| `Runtime context` | `"instructions"` | 无 | [`{ kind: "Runtime context", form: "instructions" }`](#persistence-type-sha256-9afbed70e5e73e2f07dc7c6a68b47eb3d005d62cacf785d43d62459fd61aeb09) |
...
| `Runtime context` | `"recall"` | 无 | [`{ kind: "Runtime context", form: "recall" }`](#persistence-type-sha256-b4512986aa776c53294ce8403df0da5ac2b5d79a40ebe7a795b3bd58148551a4) |
| `Runtime context` | `"relay"` | 无 | [`{ kind: "Runtime context", form: "relay" }`](#persistence-type-sha256-be081c4193ee80ad8c878b2c58d1e5ff3cc2706f05c694c2bfd5a06c03f85462) |
...
| `Runtime context` | 未声明 | 无 | [`{ kind: "Runtime context" }`](#persistence-type-sha256-a7ac62a67552520f2037c46a124707199246b7f6db46fed26d4f8d7749ccdd93) |
...
[`Message`](#persistence-type-sha256-a6e68becfba972e0d0fd9b91ecd1bf2949a18b5ca1156a496a612c37573f07ae) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-b895bae6820aeeb5c7d4b59594197a71cd0b558cafc2435095c4ce3955a82fa4) |
...
[`UserMessage`](#persistence-type-sha256-99caa511bbd70c86b2d6282bd17730cf18094c95fd3bd9a41205b059919c5e2e) 的数组。
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-c64daa8493a4e80ae825c90f25c413e8828b24eb7e58f82ad9543289073d2261) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-6d8556f4201898f13cb8d1126d84c7065df5b536fd26a7191af4327e9b59d40f) |
| `outcome` | 可选 | `"canceled"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-f53bb42b11c0eea0385469b8931a68afafae860a30f314a8b5d85f33df2037df) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-c9eeea19da0e7c4dac23ebdff817e027132f908f0d778882c068734b39d655a0) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-01f1bdd3ef806beb0da2b52a241625070de9711ffb1b868b4d2ee3a71ed46952) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-99caa511bbd70c86b2d6282bd17730cf18094c95fd3bd9a41205b059919c5e2e) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
